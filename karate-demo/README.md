...
Note that this is *not* the best example of a skeleton Java / Maven project, as it is designed to be part of the Karate code-base and act as a suite of regression tests. For a good "starter" project, please use the [Quickstart](../../#quickstart) or the sample [Spring Boot Example](../../#spring-boot-example).
