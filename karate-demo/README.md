...
[`soap.feature`](src/test/java/demo/soap/soap.feature) | Examples for both SOAP 1.1 and 1.2, also showing how you can [read](https://github.com/intuit/karate#reading-files) request payloads and even expected response XML from files.
