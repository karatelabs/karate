...
`* call read 'credentials.json'` | Since `read()` is a *function* <br/>this has the effect of loading <br/>*all* keys in the JSON file<br/>into [Shared Scope](#shared-scope) ! <br/>This *can* be [useful sometimes](karate-core#locator-lookup).
