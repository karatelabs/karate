...
* **All** variables that were defined (using [`def`](#def)) in the 'called' script would be returned as 'keys' within a JSON-like object, and in the example above you can see this JSON 'envelope' assigned to the variable named `signin`. Getting hold of any data that was generated by the 'called' script is as simple as doing `signin.authToken` as shown above. This design has the following advantages:
  ...
  * the data 'return' mechanism is 'safe' - as in there is no danger of the 'called' script over-writing any variables in the 'calling' (or parent) script.
