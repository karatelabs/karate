...
The [Karate Demo](karate-demo) has a working example of this set-up. It also shows how a third-party maven-plugin can be easily used to generate some very nice-looking reports. For example, here below is an actual report generated by the [maven-cucumber-reporting](https://github.com/damianszczepanik/maven-cucumber-reporting) plugin.
