...
**Parallel Execution** | **No**. There are some challenges (especially with reporting) and you can find various discussions and third-party projects on the web that attempt to close this gap: [1](https://opencredo.com/test-automation-concepts-parallel-test-execution/) [2](http://stackoverflow.com/questions/41034116/how-to-execute-cucumber-feature-file-parallel)   [3](https://github.com/DisneyStudios/cucumber-slices-maven-plugin) [4](https://github.com/temyers/cucumber-jvm-parallel-plugin) [5](https://github.com/trivago/cucable-plugin) | :white_check_mark: [**Yes**](#parallel-execution).
