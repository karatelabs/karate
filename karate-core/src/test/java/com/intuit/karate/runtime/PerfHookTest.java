...
class PerfHookTest {
    ...
    static void beforeAll() {
        server = MockServer
                .feature("classpath:com/intuit/karate/runtime/perf-mock.feature")
                .http(0).build();
    ...
    void testPerfHook() {
        ...
        Runner.callAsync("classpath:com/intuit/karate/runtime/perf.feature", Collections.EMPTY_LIST, arg, perfHook);
