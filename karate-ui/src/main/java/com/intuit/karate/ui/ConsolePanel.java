...
public class ConsolePanel extends BorderPane {
    ...
    private final CheckBox preStepEnabled = new CheckBox("pre step");
    ...
    public ConsolePanel(AppSession session, ScenarioPanel scenarioPanel) {
        ...
        clearButton.setOnAction(e -> refresh());
        HBox hbox = new HBox(App.PADDING);
        hbox.setSpacing(5);
        hbox.setAlignment(Pos.BASELINE_LEFT);
        hbox.getChildren().addAll(runButton, resultLabel, clearButton, preStepEnabled);
        setBottom(hbox);
